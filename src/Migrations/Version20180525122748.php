 ...
 */
class Version20180525122748 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, nick_name, name_surname, photo, telephone, email, password, nif, employee_code, gender, delete_id, profiler_details_id, contract_id, departmentID FROM user');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D6497B20C08');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, nick_name, name_surname, photo, telephone, email, password, nif, employee_code, gender, profiler_details_id, contract_id, delete_id, departmentID FROM user');
        $this->addSql('DROP TABLE user');
        ...
        $this->addSql('INSERT INTO user (id, nick_name, name_surname, photo, telephone, email, password, nif, employee_code, gender, profiler_details_id, contract_id, delete_id, departmentID) SELECT id, nick_name, name_surname, photo, telephone, email, password, nif, employee_code, gender, profiler_details_id, contract_id, delete_id, departmentID FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE INDEX IDX_8D93D6497B20C08 ON user (departmentID)');
    }
}
