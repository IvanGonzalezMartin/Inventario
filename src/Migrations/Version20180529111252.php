 ...
 */
class Version20180529111252 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE delivery (id VARCHAR(55) NOT NULL, order_id INTEGER NOT NULL, manager_id INTEGER NOT NULL, date DATETIME NOT NULL, sign VARCHAR(255) DEFAULT NULL, doc_sign VARCHAR(255) NOT NULL, delete_id VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE log_manager (token VARCHAR(255) NOT NULL, manager_id INTEGER NOT NULL, date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, start_date DATETIME DEFAULT NULL, PRIMARY KEY(token))');
        $this->addSql('CREATE TABLE log_user (token VARCHAR(255) NOT NULL, user_id INTEGER NOT NULL, date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, start_date DATETIME DEFAULT NULL, PRIMARY KEY(token))');
        ...
        $this->addSql('CREATE TABLE order_clothe (id VARCHAR(250) NOT NULL, user_id VARCHAR(50) NOT NULL, date DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL, delivery_id VARCHAR(250) DEFAULT NULL, delete_id VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
