 ...
 */
class Version20180514121554 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE manager (id INTEGER NOT NULL, nick_name VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, rol_id INTEGER NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, delete_id VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
