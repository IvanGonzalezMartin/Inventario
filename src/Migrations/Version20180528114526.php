 ...
 */
class Version20180528114526 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE log_user (token VARCHAR(255) NOT NULL, user_id INTEGER NOT NULL, date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, PRIMARY KEY(token))');
