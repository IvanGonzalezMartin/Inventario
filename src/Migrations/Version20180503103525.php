 ...
 */
class Version20180503103525 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE delete_thing ADD COLUMN delete_id VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__delete_thing AS SELECT id, delete_thing_id, name_of_thing, manager_id, user_id, date, description FROM delete_thing');
        ...
        $this->addSql('INSERT INTO delete_thing (id, delete_thing_id, name_of_thing, manager_id, user_id, date, description) SELECT id, delete_thing_id, name_of_thing, manager_id, user_id, date, description FROM __temp__delete_thing');
        $this->addSql('DROP TABLE __temp__delete_thing');
    }
}
