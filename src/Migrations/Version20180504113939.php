 ...
 */
class Version20180504113939 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE delete_thing (id VARCHAR(50) NOT NULL, delete_id VARCHAR(50) NOT NULL, delete_thing_id VARCHAR(50) NOT NULL, name_of_thing VARCHAR(255) NOT NULL, manager_id VARCHAR(50) DEFAULT NULL, user_id VARCHAR(50) DEFAULT NULL, date DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
