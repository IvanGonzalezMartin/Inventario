 ...
 */
class Version20180425110232 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE clothes_category_entity (id INTEGER NOT NULL, clothe_name VARCHAR(255) NOT NULL, type_id VARCHAR(255) NOT NULL, "delete" BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE clothes_entity (id INTEGER NOT NULL, category_id INTEGER NOT NULL, clothe_name VARCHAR(255) NOT NULL, clothe_descripcion CLOB NOT NULL, delete_clothe BOOLEAN NOT NULL, foto VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE gestor_entity (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, role VARCHAR(255) DEFAULT \'0\' NOT NULL, password VARCHAR(255) NOT NULL, active BOOLEAN DEFAULT \'1\' NOT NULL, email VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, "delete" BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE profile_entity (id INTEGER NOT NULL, shoe_size_id INTEGER NOT NULL, long_sleeve_shirt VARCHAR(255) NOT NULL, short_sleeve_shirt VARCHAR(255) NOT NULL, fleece VARCHAR(255) NOT NULL, polo_shirt_men_short_sleeve VARCHAR(255) NOT NULL, polo_shirt_men_long_sleeve VARCHAR(255) NOT NULL, polo_shirt_woman_short_sleeve VARCHAR(255) NOT NULL, polo_shirt_woman_long_sleeve VARCHAR(255) NOT NULL, jacket VARCHAR(255) NOT NULL, vest VARCHAR(255) NOT NULL, "delete" BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE sizes_entity (id INTEGER NOT NULL, size VARCHAR(255) NOT NULL, "delete" BOOLEAN NOT NULL, type_id VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE type_size_entity (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, "delete" BOOLEAN NOT NULL, PRIMARY KEY(id))');
